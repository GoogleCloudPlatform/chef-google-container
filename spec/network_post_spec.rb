...
describe Google::Container::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Container::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Container::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Container::NetworkBlocker.instance.deny(uri_in) }
