...
describe Google::Container::Network::Get do
  let(:credential) { TestCred.new }
  let(:uri) { Google::Container::NetworkBlocker::ALLOWED_TEST_URI }

  context 'successful request' do
    before(:each) do
      Google::Container::NetworkBlocker.instance.allow_get(
  ...
  context 'failed request' do
    before(:each) { Google::Container::NetworkBlocker.instance.deny(uri) }
