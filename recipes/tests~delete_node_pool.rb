...
#       "recipe[gcontainer::tests~delete_node_pool]"
#
...
gcontainer_cluster "chef-e2e-mycluster-#{ENV['cluster_id']}" do
  action :create
  zone 'us-central1-a'
...
gcontainer_node_pool 'chef-e2e-web-servers' do
  action :delete
  cluster "chef-e2e-mycluster-#{ENV['cluster_id']}"
  zone 'us-central1-a'
  project 'google.com:graphite-playground'
  credential 'mycred'
end
