...
module Google
  module Container
    module Data
      ...
      # Imports name from cluster
      class ClusterNameRef
        include Comparable

        def ==(other)
          return false unless other.is_a? ClusterNameRef
      ...
      class ClusterNameRefCatalog < ClusterNameRef
    ...
    module Property
      ...
      class ClusterNameRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Container::Property::ClusterNameRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::ClusterNameRef
          Data::ClusterNameRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::ClusterNameRef
          Data::ClusterNameRefApi.new(value)
        end
      end
    end
  end
