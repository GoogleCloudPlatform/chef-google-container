...
name 'google-gcontainer'
maintainer 'Google'
maintainer_email 'nelsona@google.com'
license 'apachev2'
description 'A Chef cookbook to manage Google Container Engine resources'
long_description '
...
source_url 'https://github.com/GoogleCloudPlatform/chef-google-container' \
